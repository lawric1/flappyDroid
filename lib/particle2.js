import { lerp, randomInt, randomFloat, toRadians } from "./math.js";
...
export class Particle {
    ...
    init(x, y, config) {
        ...
        this.vely = config.velocity * this.direction.y * randomInt(0, 5);
    ...
    update(deltaTime) {
        ...
        if (this.maxFrames === 1){
            ...
            this.currentFrame = Math.floor(lerp(0, this.maxFrames, 1 - this.lifetime, ""));
        }
